...
export function stakingDataToCsvRow(rowData: CsvRowStakingData): string[] {
    const rewardAmtLux = rowData.isRewardOwner
        ? rowData.rewardAmtLux.toString()
...
export function luxTransferDataToCsvRow(rowData: CsvRowLuxTransferData): string[] {
