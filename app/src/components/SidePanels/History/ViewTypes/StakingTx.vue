<template>
    <div class="staking_tx">
        ...
        <div class="data_row" v-if="isValidator && receivedValidatorReward">
            ...
            <p class="amt">{{ formatRewardAmount(validatorRewardAmount) }} LUX</p>
        </div>
        ...
        <div class="data_row" v-if="!isValidator && receivedDelegatorReward">
            ...
            <p class="amt">{{ formatRewardAmount(delegatorRewardAmount) }} LUX</p>
        </div>
    </div>
</template>
<script lang="ts">
...
import { PChainTransaction, PChainUtxo, RewardType } from '@luxdefi/glacier-sdk'
