                ...
                <template>
                    ...
                    <div class="fee">
                        <p>
                            ...
                            <span>{{ txFee.toLocaleString() }} LUX</span>
                        </p>
                    </div>
                    <v-btn
                        :disabled="!canSubmit"
...
import { PayloadBase, URLPayload, UTF8Payload, JSONPayload } from 'luxnet/dist/utils'
