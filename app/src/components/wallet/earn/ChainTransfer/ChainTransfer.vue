            ...
            <div class="form">
                ...
                <div v-if="!isSuccess && !isLoading">
                    <div v-if="!isImportErr" class="fees">
                        ...
                        <p>
                            Export Fee
                            <span>{{ exportFee.toLocaleString() }} LUX</span>
                        </p>
                        <p>
                            Import Fee
                            <span>{{ importFee.toLocaleString() }} LUX</span>
                        </p>
                        <p>
                            <b>
                                Total
                                <span>{{ fee.toLocaleString() }} LUX</span>
                            </b>
                        </p>
                    </div>
                    <div>
...
class ChainTransfer extends Vue {
    $refs!: {
        form: ChainSwapForm
    }
    ...
    get ava_asset(): LuxAsset | null {
        let ava = this.$store.getters['Assets/AssetLUX']
        return ava
    }
